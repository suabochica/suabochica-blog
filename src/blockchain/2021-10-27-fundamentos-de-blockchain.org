...
- [[https://ethereum.org/en/][Ethereum]], cambio de PoW a PoS en el proyecto casper
- [[https://www.dash.org/][DASH]], un pionero de PoS
- [[https://lisk.com/][LISK]], una herramienta enfocada en la creación de aplicaciones descentralizadas.
...
#+CAPTION: How works DBFT
[[../../images/blockchain/15-dbft.png]]
...
- [[https://bitcoin.org/bitcoin.pdf][PoW en el artículo de Bitcoin]]
- [[https://github.com/ethereum/wiki/wiki/Proof-of-Stake-FAQ][PoS Ethereum FAQs]]
- [[https://steemit.com/neo/@basiccrypto/neo-s-consensus-protocol-how-delegated-byzantine-fault-tolerance-works][Protocolo de Consenso de NEO]]
- [[https://www.coinbureau.com/blockchain/proof-of-activity-explained-hybrid-consensus-algorithm/][Prueba de Actividad]]
- [[https://99bitcoins.com/what-is-proof-of-burn/][Prueba de Quemadura]]
...
Bloques, valores hash, grupos de memoria, consenso y algoritmos de consenso son ahora conceptos familiares para el lector.