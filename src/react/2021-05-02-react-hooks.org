...
** DONE Comparación co el ejercicio previo y descripción
...
** DONE Crear el archivo ImageToggleOnScroll
...
** DONE Crear el archivo ImageChangeOnScroll
...
** DONE Bug con la primera imagen
   CLOSED: [2021-05-23 Sun 17:14]
...
** DONE Explicar la estructura del useEffect y el parametro []
...
** DONE Modificar el archvio ImageChangeOnScroll para agregar el efecto secundario de mostrar el identificador del expositor en el título cuando el cursor está sobre la imagen
...
** DONE Explicar el contador del evento del ratón
   CLOSED: [2021-06-01 Tue 09:30]
El estado ~[mouseEventCounter, setMouseEventCounter] = useState(0)~ es otro efecto secundario que se incluye para tener un registro de las veces que se activa el evento ~onMouseOver~.
...
** TODO Señalar el problema de optimización asociado al evento del botón
