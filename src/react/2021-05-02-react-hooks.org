...
** PROGRESS Modificar el archvio ImageChangeOnScroll para agregar el efecto secundario de mostrar el identificador del expositor en el título cuando el cursor está sobre la imagen
...
const ImageChangeOnScroll = () => {
  ...
  const [mouseEventCounter, setMouseEventCountr] = useState(0);
        ...
        return (
          <div key={speakerId}
            onMouseOver={() => {
              ...
              setMouseEventCountr(mouseEventCounter++);
            }
          }>
            <ImageToggleOnScroll
              primaryImg="/static/speakers/bw/speaker-${speakerId}.jpg"
...
** TODO Explicar el contador del evento del ratón
