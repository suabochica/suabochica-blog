...
Al cargar el servidor ahora se puede observar en el navegador una aplicación funcional que persiste las votaciones realizadas por respuesta a través de una utilidad definida en el servidor.
