#+TITLE: Styling & Layout in React Native
#+DESCRIPTION: CSS-in-JS in React Native, the StyleSheet API, flexbox differences from the web, and professional styling approaches.
...
React Native also gives you the [[https://facebook.github.io/react-native/docs/dimensions.html][Dimensions API]] to grab the device's window width and height:
