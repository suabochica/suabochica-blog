...
#+DESCRIPTION: First post in a series on React Native — what it is, how it works under the hood, and how to set up a development environment with CRNA and Expo.
