...
## ¿Qué son los React Hooks? {#qué-son-los-react-hooks}
...
-   Note taken on <span class="timestamp-wrapper"><span class="timestamp">[2021-05-14 Fri 18:18] </span></span> <br />
    note test
...
## Usando `useEffect`, `useRef` y `useState` para dar color con un efecto de scroll {#usando-useeffect-useref-y-usestate-para-dar-color-con-un-efecto-de-scroll}


### <span class="org-todo done DONE">DONE</span> Comparación co el ejercicio previo y descripción {#comparación-co-el-ejercicio-previo-y-descripción}
...
### <span class="org-todo done DONE">DONE</span> Crear el archivo ImageToggleOnScroll {#crear-el-archivo-imagetoggleonscroll}
...
### <span class="org-todo done DONE">DONE</span> Crear el archivo ImageChangeOnScroll {#crear-el-archivo-imagechangeonscroll}
...
### <span class="org-todo done DONE">DONE</span> Bug con la primera imagen {#bug-con-la-primera-imagen}
...
## Agregando un efecto secundario al componente Scroller {#agregando-un-efecto-secundario-al-componente-scroller}


### <span class="org-todo done DONE">DONE</span> Explicar la estructura del useEffect y el parametro [] {#explicar-la-estructura-del-useeffect-y-el-parametro}
...
### <span class="org-todo done DONE">DONE</span> Modificar el archvio ImageChangeOnScroll para agregar el efecto secundario de mostrar el identificador del expositor en el título cuando el cursor está sobre la imagen {#modificar-el-archvio-imagechangeonscroll-para-agregar-el-efecto-secundario-de-mostrar-el-identificador-del-expositor-en-el-título-cuando-el-cursor-está-sobre-la-imagen}
...
### <span class="org-todo done DONE">DONE</span> Explicar el contador del evento del ratón {#explicar-el-contador-del-evento-del-ratón}
...
### <span class="org-todo done DONE">DONE</span> Señalar el problema de optimización asociado al evento del botón {#señalar-el-problema-de-optimización-asociado-al-evento-del-botón}
