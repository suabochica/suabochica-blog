...
CRNA viene con miles de iconos vectoriales listos para usar. Revisa el [directorio de iconos vectoriales de Expo](https://expo.github.io/vector-icons) para ver la lista completa. Solo elige un conjunto de iconos que se ajuste a la apariencia de tu app.
...
Hemos cubierto lo esencial, pero la lista continúa. Revisa la [documentación de React Native](https://facebook.github.io/react-native/docs/components-and-apis.html#components-and-apis) para ver todo lo disponible. Ten en cuenta que algunos componentes son específicos de cada plataforma. Generalmente querrás componentes multiplataforma mediante composición, pero a veces tiene sentido que iOS y Android difieran.
